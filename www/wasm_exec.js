...
(() => {
  ...
  if (!global.fs) {
    ...
    var filerFs = new Filer.FileSystem();
    ...
    global.fs = {
      ...
      mkdir(path, perm, callback) {
        filerFs.mkdir(path, function (err) {
          const real_err = err.code == 'EEXIST' ? null : err;
          console.log(real_err);
          callback(real_err);
        });
      },
      open(path, flags, mode, callback) {
        console.log(path);
        filerFs.open(path, mode, callback);
      },
